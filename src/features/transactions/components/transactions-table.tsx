...
import { parseAddress } from '@/features/address/types';
          ...
          {rows.map((row) => {
            ...
            return (
              <TableRow key={row.id}>
                ...
                >
                  <span className='font-medium'>{addr.district ?? '-'}</span>
                </IconCell>
                <TableCell>{addr.khoroo ?? '-'}</TableCell>
                <TableCell>{addr.streetBuilding ?? '-'}</TableCell>
                <TableCell>{addr.apartmentNumber ?? '-'}</TableCell>
                <TableCell>
