...
import { TransactionsGrouped } from './transactions-grouped';
...
export function TransactionsView() {
  ...
  const rows: TransactionRow[] = useMemo(() => {
    ...
    return apiBinUsages.map((usage) => ({
      ...
      district: usage.district ?? null,
      khoroo: usage.khoroo ?? null,
      streetBuilding: usage.streetBuilding ?? null,
      apartmentNumber: usage.apartmentNumber ?? null,
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <CardDescription>
                      ...
                      • {pagination.statistics?.uniqueBinCount || 0} сав •
