 ...
 */
const DRAIN_HINT =
  'Батерей хоногт хэдэн хувиар буурч байна вэ. Жишээ нь 3%/хоног гэвэл ' +
  'дүүрэн батерей 30 гаруй хоногийн дараа дуусна гэсэн үг. Тоо нь их бол ' +
  'тэр сав хурдан суудаг.';

const HOLD_HINT =
  'Цэнэглээд хэр удаан ашиглах боломжтой вэ?

Сав нэг удаагийн цэнэгээр хэдэн хоног ашиглагдахыг энд харуулна. Хугацаа урт байх тусам цэнэгээ удаан барина.

«Хамгийн багадаа» гэж байвал заасан хоног нь баталгаатай доод хугацаа бөгөөд түүнээс илүү хоног ашиглах боломжтой гэсэн үг.
