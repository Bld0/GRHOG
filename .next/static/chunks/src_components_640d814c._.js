...
function setThemeCookie(theme) {
    ...
    ;
    document.cookie = "".concat(COOKIE_NAME, "=").concat(theme, "; path=/; max-age=31536000; SameSite=Lax; ").concat(window.location.protocol === 'https:' ? 'Secure;' : '');
}
const ThemeContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function ActiveThemeProvider(param) {
    let { children, initialTheme } = param;
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ActiveThemeProvider.useEffect": ()=>{
            ...
            document.body.classList.add("theme-".concat(activeTheme));
...
function Providers(param) {
    let { activeThemeValue, children } = param;
