...
"[project]/node_modules/nprogress/nprogress.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/nextjs-toploader/dist/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
function error(code) {
    return "[nuqs] ".concat(errors[code], "\n  See https://err.47ng.com/NUQS-").concat(code);
}
// src/url-encoding.ts
...
function isDebugEnabled() {
    ...
    const debug2 = (_localStorage_getItem = localStorage.getItem("debug")) !== null && _localStorage_getItem !== void 0 ? _localStorage_getItem : "";
...
function createAdapterProvider(useAdapter2) {
    return (param)=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"])(context.Provider, {
            ...props,
            value: {
...
function renderURL(base, search) {
    var _base_split_;
    const hashlessBase = (_base_split_ = base.split("#")[0]) !== null && _base_split_ !== void 0 ? _base_split_ : "";
...
//# sourceMappingURL=node_modules_46cd6cda._.js.map