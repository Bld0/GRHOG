...
"[project]/src/features/overview/components/bar-graph-skeleton.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: Array.from({
                        length: 15
                            ...
                            className: "w-full",
                            style: {
                                height: "".concat(Math.max(30, Math.random() * 80), "%")
                            }
                        }, i, false, {
                            fileName: "[project]/src/features/overview/components/bar-graph-skeleton.tsx",
                            lineNumber: 28,
...
_c = BarGraphSkeleton;
var _c;
__turbopack_context__.k.register(_c, "BarGraphSkeleton");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/features/overview/components/bar-graph.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$overview$2f$components$2f$bar$2d$graph$2d$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/overview/components/bar-graph-skeleton.tsx [app-client] (ecmascript)");
;
...
;
;
const description = 'Хорооны ашиглалтын график';
const chartConfig = {
    value: {
        label: ' Ашиглалт',
        color: 'var(--primary)'
...
function BarGraph() {
    _s();
    const [range, setRange] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]('month');
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "BarGraph.useEffect": ()=>{
            let mounted = true;
            var _API_CONFIG_ENDPOINTS_DASHBOARD_GET_DISTRICT;
            // fetch districts list from new endpoint that returns string[]
            fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildApiUrl"])((_API_CONFIG_ENDPOINTS_DASHBOARD_GET_DISTRICT = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.DASHBOARD.GET_DISTRICT) !== null && _API_CONFIG_ENDPOINTS_DASHBOARD_GET_DISTRICT !== void 0 ? _API_CONFIG_ENDPOINTS_DASHBOARD_GET_DISTRICT : '/dashboard/getDistrict'), {
                headers: {
                ...
                "BarGraph.useEffect": (r)=>r.json()
            }["BarGraph.useEffect"]).then({
                "BarGraph.useEffect": (json)=>{
                    if (!mounted) return;
                    // endpoint returns an array of district strings
                    const locs = Array.isArray(json) ? json.map({
                        "BarGraph.useEffect": (s)=>String(s)
                    }["BarGraph.useEffect"]).filter(Boolean) : [];
                    setDistricts(locs);
                }
            }["BarGraph.useEffect"]).catch({
                "BarGraph.useEffect": ()=>{
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "BarGraph.useEffect": ()=>{
            ...
            fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildApiUrl"])("/dashboard/khoroo-usage?".concat(params.toString())), {
                headers: {
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authUtils"].getAuthHeader()
                }
            }).then({
                "BarGraph.useEffect": async (r)=>{
                ...
                "BarGraph.useEffect": (json)=>{
                    ...
                    const chartData = labels.map({
                        "BarGraph.useEffect.chartData": (label, idx)=>{
                            var _values_idx;
                            const item = {
                                name: label,
                                total: (_values_idx = values[idx]) !== null && _values_idx !== void 0 ? _values_idx : 0 // json.data-аас total авах
                            };
                            // type талбаруудыг нэмэх
                            for(const typeKey in json.type){
                                var _json_type_typeKey_idx;
                                item[typeKey] = (_json_type_typeKey_idx = json.type[typeKey][idx]) !== null && _json_type_typeKey_idx !== void 0 ? _json_type_typeKey_idx : 0;
                            }
                            return item;
                        }
                    }["BarGraph.useEffect.chartData"]);
                    // Bar chart-д ашиглах data
                    const mapped = labels.map({
                        "BarGraph.useEffect.mapped": (label, i)=>{
                            var _values_i;
                            return {
                                name: label,
                                value: Number((_values_i = values[i]) !== null && _values_i !== void 0 ? _values_i : 0),
                                type: chartData // Tooltip-д ашиглах бүх өгөгдөл
                            };
                        }
                    }["BarGraph.useEffect.mapped"]);
                    console.log('Khoroo usage data:', mapped);
                    setData(mapped);
                }
            }["BarGraph.useEffect"]).catch({
                "BarGraph.useEffect": (err)=>{
                    if (!mounted) return;
                    var _err_message;
                    setError(typeof err === 'string' ? err : (_err_message = err.message) !== null && _err_message !== void 0 ? _err_message : 'Алдаа');
                    setData([]);
                }
            }["BarGraph.useEffect"]).finally({
                "BarGraph.useEffect": ()=>{
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "BarGraph.useEffect": ()=>setIsClient(true)
    }["BarGraph.useEffect"], []);
    if (!isClient) return null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "@container/card !pt-3",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                className: "flex flex-col items-stretch space-y-0 border-b !p-0 sm:flex-row",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-1 flex-col justify-center gap-1 px-6 !py-0",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                children: "Хорооны ашиглалт"
                            }, void 0, false, {
                                fileName: "[project]/src/features/overview/components/bar-graph.tsx",
                                lineNumber: 169,
                                columnNumber: 11
                            }, this),
                        ...
                        children: [
                            [
                                ...
                                'today'
                                    ...
                                    children: r === '12month' ? '12 сар' : r === 'month' ? 'Сар' : r === 'week' ? '7 хоног' : 'Өнөөдөр'
                                }, r, false, {
                                    fileName: "[project]/src/features/overview/components/bar-graph.tsx",
                                    lineNumber: 177,
                                    columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChartContainer"], {
                    ...
                    children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$overview$2f$components$2f$bar$2d$graph$2d$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BarGraphSkeleton"], {}, void 0, false, {
                        fileName: "[project]/src/features/overview/components/bar-graph.tsx",
                        lineNumber: 221,
                        columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChartTooltip"], {
                                    ...
                                    content: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChartTooltipContent"], {
                                        ...
                                        formatter: (value, name, props)=>{
                                            var _props_payload;
                                            const row = (_props_payload = props === null || props === void 0 ? void 0 : props.payload) !== null && _props_payload !== void 0 ? _props_payload : {};
                                            // type array-с data.name-тэй тэнцэх мэдээллийг олох
                                            if (row.type && Array.isArray(row.type)) {
                                                const matchedType = row.type.find((item)=>item.name === row.name);
                                                if (matchedType) {
                                                    // 0-ээс их утгатай талбаруудыг шүүх
                                                    const breakdown = Object.entries(matchedType).filter((param)=>{
                                                        let [k, v] = param;
...
_s(BarGraph, "+D4WwQok36TT0ZgeX1yomBRF0+k=");
_c = BarGraph;
var _c;
...
//# sourceMappingURL=src_103bb230._.js.map