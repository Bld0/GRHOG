...
"[project]/.next-internal/server/app/api/bins/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/bins/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const url = `${backendUrl}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.BINS}${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
...
async function POST(request) {
    try {
        ...
        const backendUrl = process.env.BACKEND_URL || 'http://device.grhog.mn';
        const response = await fetch(`${backendUrl}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.BINS}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__902ecb4f._.js.map