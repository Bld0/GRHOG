...
"[project]/.next-internal/server/app/api/dashboard/getDistrict/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/dashboard/getDistrict/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const response = await fetch(`${backendUrl}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.DASHBOARD.GET_DISTRICT}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                ...authHeader ? {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b61b6403._.js.map