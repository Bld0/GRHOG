...
"[project]/src/features/overview/components/pie-graph-skeleton.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/overview/components/pie-graph.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$overview$2f$components$2f$pie$2d$graph$2d$skeleton$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/overview/components/pie-graph-skeleton.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function PieGraph() {
    ...
    const [khorooList, setKhorooList] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"]([]);
    const [khoroo, setKhoroo] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"]('');
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        let mounted = true;
        fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildApiUrl"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.DASHBOARD.GET_DISTRICT), {
            headers: {
            ...
            if (!mounted) return;
            const list = Array.isArray(json) ? json.map((s)=>String(s)).filter(Boolean) : [];
            setDistricts(list);
        }).catch(()=>{}).finally(()=>{});
        return ()=>{
            mounted = false;
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        ...
        setKhoroo('');
        if (!district) return;
        fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildApiUrl"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.DASHBOARD.GET_KHOROO + `?district=${encodeURIComponent(district)}`), {
            headers: {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authUtils"].getAuthHeader()
            }
        }).then((r)=>r.json()).then((json)=>{
            if (!mounted) return;
            const list = Array.isArray(json) ? json.map((n)=>Number(n)).filter((x)=>!Number.isNaN(x)) : [];
            setKhorooList(list);
        }).catch(()=>{}).finally(()=>{});
        return ()=>{
            mounted = false;
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        ...
        fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildApiUrl"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.DASHBOARD.CLIENT_TYPE_COUNTS + `?${params.toString()}`), {
            headers: {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authUtils"].getAuthHeader()
            }
        }).then(async (r)=>{
            ...
            if (!mounted) return;
            const list = Array.isArray(json) ? json.map((x)=>({
                    type: String(x.type),
    ...
    if ("TURBOPACK compile-time truthy", 1) return null; // client only
...
//# sourceMappingURL=src_013938e1._.js.map