...
"[project]/.next-internal/server/app/api/dashboard/current-usage/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/dashboard/current-usage/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const response = await fetch(`${backendUrl}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.DASHBOARD.CURRENT_USAGE}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                ...authHeader ? {
        ...
        console.error('Error fetching dashboard current usage:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to fetch dashboard current usage'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__75485fad._.js.map