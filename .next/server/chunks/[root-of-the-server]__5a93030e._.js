...
async function GET(request) {
    try {
        ...
        const url = `${backendUrl}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.CLIENTS}${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
...
async function POST(request) {
    try {
        ...
        const backendUrl = process.env.BACKEND_URL || 'http://device.grhog.mn';
        const response = await fetch(`${backendUrl}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].ENDPOINTS.CLIENTS}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5a93030e._.js.map